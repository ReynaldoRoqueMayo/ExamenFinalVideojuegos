...
import com.example.examenfinalandroid.Adapters.PokemonsAdapterC;
...
public class ListaCapturadosActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lista_capturados);
        ...
        Call<List<PokeCap>> llamadoPokemons=servicioPokemon.obtenerCapturados();
        ...
        llamadoPokemons.enqueue(new Callback<List<PokeCap>>() {
            ...
            public void onResponse(Call<List<PokeCap>> call, Response<List<PokeCap>> response) {
                ...
                Log.i("MENSAJEEEE","SI SE PUDO OBTENER CAPTURADOS");
                RecyclerView rv = findViewById(R.id.rvMisPokemonC);

                rv.setLayoutManager(new LinearLayoutManager(ListaCapturadosActivity.this));


                PokemonsAdapterC pokemonsAdapter = new PokemonsAdapterC(response.body());
